...
class CharacterStats extends GameObject {
  constructor(characterstartsAttributes){
    super(characterstartsAttributes)
    this.name = characterstartsAttributes.name;
  }
takeDamage(){
  return `${this.name} took damage`
}
}
 const mage = new CharacterStats({ name:"Bruce"
})
...
class Humanoid{
  constructor(attributes){
    ...
    this.languege = attributes.languege;
    this.name = attributes.name
  }
    greet(){
      return `${this.name} a greating in ${this.languege}`
    }    
}
